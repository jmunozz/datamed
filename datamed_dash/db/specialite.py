...
def get_erreur_med_population(cis):
    return return_sub_df_or_none(
        fetch_table("erreur_med_population", "cis"), cis
    )

def get_erreur_med_cause(cis):
    return return_sub_df_or_none(
        fetch_table("erreur_med_cause", "cis"), cis
    )

def get_erreur_med_nature(cis):
    return return_sub_df_or_none(
        fetch_table("erreur_med_nature", "cis"), cis
    )

def get_erreur_med_denom(cis):
    return return_sub_df_or_none(
        fetch_table("erreur_med_cis_denomination", "cis"), cis
    )
...
def get_description_df(cis):
    return return_sub_df_or_none(
        fetch_table("description", "cis"), cis
    )


def get_atc_df(cis) -> pd.DataFrame:
    spe_atc_df =  return_sub_df_or_none(
        fetch_table("specialite_atc", "cis"), cis
    )
