...
def Box(children, class_name_wrapper="col-md-12", class_name="", style=None) -> Component:
    class_name=f"box {class_name}"
    return html.Div(html.Div(children, className=class_name, style=style), className=class_name_wrapper)
...
def SectionTitle(title: str) -> Component:
    return dbc.Row(html.Div(html.Div(title, className="heading-4 d-inline-block"), className="col-12"),className="section-title")
